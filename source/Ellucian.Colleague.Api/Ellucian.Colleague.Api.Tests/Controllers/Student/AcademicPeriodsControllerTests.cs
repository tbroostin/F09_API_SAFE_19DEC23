...
namespace Ellucian.Colleague.Api.Tests.Controllers.Student
{
    ...
    public class AcademicPeriodsControllerTests3
    {
        ...
        {
            var expected = _allAcademicPeriodsDto.FirstOrDefault();
            _academicPeriodServiceMock.Setup(x => x.GetAcademicPeriodByGuid3Async(expected.Id)).ReturnsAsync(expected);
        ...
        {
            var expected = _allAcademicPeriodsDto.FirstOrDefault();
            _academicPeriodServiceMock.Setup(x => x.GetAcademicPeriodByGuid3Async(expected.Id)).Throws<Exception>();
            Debug.Assert(expected != null, "expected != null");

...
namespace Ellucian.Colleague.Api.Controllers.Base
{
    ...
    public class CommencementSitesController : BaseCompressedApiController
    {
        ...
        public async Task<IEnumerable<Ellucian.Colleague.Dtos.Base.CommencementSite>> GetAsync()
        {
            ...
            {
                logger.Error(ex, "Unable to retrieve commencement site information");
                throw CreateHttpResponseException("Unable to retrieve commencement site information", HttpStatusCode.BadRequest);
            }
        }

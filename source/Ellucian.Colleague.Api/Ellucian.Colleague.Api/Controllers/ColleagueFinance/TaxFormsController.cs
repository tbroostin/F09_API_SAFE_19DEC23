...
{
    /// <summary>
    /// Provides access to TaxFormsController
    /// </summary>
    [Authorize]
    [LicenseProvider(typeof(EllucianLicenseProvider))]
    [EllucianLicenseModule(ModuleConstants.ColleagueFinance)]
    public class TaxFormsController : BaseCompressedApiController
    {
        ...
        public TaxFormsController(ITaxFormsService taxFormsService, ILogger logger)
        {

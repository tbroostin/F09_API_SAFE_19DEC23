...
namespace Ellucian.Colleague.Api.Controllers.HumanResources
{
    ...
    public class HumanResourcesTaxFormStatementsController : BaseCompressedApiController
    {
        ...
        /// </accessComments>
        public async Task<IEnumerable<TaxFormStatement3>> GetW22Async(string personId)
        {
        ...
        /// </accessComments>
        public async Task<IEnumerable<TaxFormStatement3>> Get1095c2Async(string personId)
        {
            if (string.IsNullOrEmpty(personId))
                throw CreateHttpResponseException("Person ID must be specified.", HttpStatusCode.BadRequest);
        ...
        /// </accessComments>
        public async Task<IEnumerable<TaxFormStatement3>> GetT42Async(string personId)
        {
            if (string.IsNullOrEmpty(personId))
                throw CreateHttpResponseException("Person ID must be specified.", HttpStatusCode.BadRequest);

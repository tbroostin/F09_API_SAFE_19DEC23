...
namespace Ellucian.Colleague.Api.Controllers.Student
{
    ...
    public class StudentTaxFormStatementsController : BaseCompressedApiController
    {
        ...
        /// </accessComments>
        public async Task<IEnumerable<TaxFormStatement3>> Get10982Async(string personId)
        {
            ...
            try
            {
                return await taxFormStatementService.Get2Async(personId, Domain.Base.TaxFormTypes.Form1098);
            }
        ...
        /// </accessComments>
        public async Task<IEnumerable<TaxFormStatement3>> GetT2202a2Async(string personId)
        {
            if (string.IsNullOrEmpty(personId))
                throw CreateHttpResponseException("Person ID must be specified.", HttpStatusCode.BadRequest);
            ...
            try
            {
                return await taxFormStatementService.Get2Async(personId, Domain.Base.TaxFormTypes.FormT2202A);
            }
            catch (ColleagueSessionExpiredException csse)
            {
                logger.Error(csse, csse.Message);

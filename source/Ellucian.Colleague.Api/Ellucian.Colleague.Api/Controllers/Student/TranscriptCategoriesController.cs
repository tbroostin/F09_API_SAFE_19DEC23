...
namespace Ellucian.Colleague.Api.Controllers
{
    ...
    public class TranscriptCategoriesController : BaseCompressedApiController
    {
        ...
        public TranscriptCategoriesController(IAdapterRegistry adapterRegistry, IStudentReferenceDataRepository referenceDataRepository)
        {
        ...
        public async Task<IEnumerable<TranscriptCategory>> GetAsync()
        {

    ...
    public class PersonServiceTests
    {
        ...
        public class CreatePerson3 : CurrentUserSetup
        {
            ...
            public void Initialize()
            {
                ...
                personRepositoryMock.Setup(i => i.Create2Async(It.IsAny<PersonIntegration>(), addresses, phones)).ReturnsAsync(personIntegrationReturned);
        ...
        #region HEDM CreatePerson V12 Tests
        ...
        public class UpdatePerson3 : CurrentUserSetup
        {
            ...
            public void Initialize()
            {
                ...
                personRepositoryMock.Setup(i => i.Update2Async(It.IsAny<PersonIntegration>(), addresses, phones)).ReturnsAsync(personIntegrationReturned);
        ...
        public class CreateUpdatePerson3WithAddressPhoneSocialMedia : CurrentUserSetup
        {
            ...
            public void Initialize()
            {
                ...
                personRepositoryMock.Setup(i => i.Update2Async(It.IsAny<PersonIntegration>(), It.IsAny<IEnumerable<Domain.Base.Entities.Address>>(),
                    It.IsAny<IEnumerable<Ellucian.Colleague.Domain.Base.Entities.Phone>>())).ReturnsAsync(personIntegrationReturned);
            ...
            public async Task UpdatePerson3_UpdatePerson3Async_PersonId_NullEmpty_Create()
            {
                ...
                personRepositoryMock.Setup(i => i.Create2Async(It.IsAny<PersonIntegration>(), It.IsAny<IEnumerable<Domain.Base.Entities.Address>>(), It.IsAny<IEnumerable<Domain.Base.Entities.Phone>>())).ReturnsAsync(personIntegrationReturned);
            ...
            public async Task UpdatePerson3_NullAddress_Exception()
            {
                ...
                personRepositoryMock.Setup(i => i.Create2Async(It.IsAny<PersonIntegration>(), It.IsAny<IEnumerable<Domain.Base.Entities.Address>>(), phones)).ReturnsAsync(personIntegrationReturned);
        ...
        #region HEDM Update Person V12 Tests
        ...
        #region HEDM GetPerson V12 Tests

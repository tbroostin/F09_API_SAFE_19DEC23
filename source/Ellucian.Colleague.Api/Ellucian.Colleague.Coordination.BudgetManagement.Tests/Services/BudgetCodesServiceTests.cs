...
namespace Ellucian.Colleague.Coordination.BudgetManagement.Tests.Services
{
    ...
    [TestClass]
    public class BudgetCodesServiceTests  : BudgetUser
    {
        ...
        public async void Initialize()
        {
            ...
            budgetRole.AddPermission(new Ellucian.Colleague.Domain.Entities.Permission(BudgetManagementPermissionCodes.ViewBudgetCode));

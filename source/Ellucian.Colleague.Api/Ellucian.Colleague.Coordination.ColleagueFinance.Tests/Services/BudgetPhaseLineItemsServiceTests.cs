...
{
    [TestClass]
    public class BudgetPhaseLineItemsServiceTests_V12
    {
        [TestClass]
        public class PurchaseOrderServiceTests_GET_GETALL_V12 : GeneralLedgerCurrentUser
        {
            #region DECLARATION
            ...
            public void Initialize()
            {
                ...
                currentUserFactory = new GeneralLedgerCurrentUser.BudgetUser();
            ...
            {
                viewBudgetPhaseLineItems.AddPermission(new Ellucian.Colleague.Domain.Entities.Permission(ColleagueFinancePermissionCodes.ViewBudgetPhaseLineItems));

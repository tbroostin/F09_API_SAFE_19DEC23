...
{
    [TestClass]
    public class BudgetPhasesServiceTests  : GeneralLedgerCurrentUser
    {
        ...
        Tuple<IEnumerable<Budget>, int> _budgetPhasesCollection;
        ...
        public async void Initialize()
        {
            ...
            _budgetPhasesCollection = new Tuple<IEnumerable<Budget>, int>
            ...
            budgetRole.AddPermission(new Ellucian.Colleague.Domain.Entities.Permission(Ellucian.Colleague.Domain.ColleagueFinance.ColleagueFinancePermissionCodes.ViewBudgetPhase));

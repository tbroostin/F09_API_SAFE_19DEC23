...
{
    [TestClass]
    public class AwardLetter3DtoToEntityAdapterTests
    {
        private AwardLetter3DtoToEntityAdapter dtoToEntityAdapter;
        private Mock<IAdapterRegistry> adapterRegistry;
        private Mock<ILogger> logger;

        private StudentAwardYear inputStudentAwardYearEntity;
        private Dtos.FinancialAid.AwardLetter3 inputAwardLetterDto;
        ...
        public void Initialize()
        {
            ...
            inputAwardLetterDto = new Dtos.FinancialAid.AwardLetter3()
            {
            ...
            dtoToEntityAdapter = new AwardLetter3DtoToEntityAdapter(adapterRegistry.Object, logger.Object);
        }

...
{
    [TestClass]
    public class AwardLetter3EntityToDtoAdapterTests
    {
        private string studentId;
        private Domain.FinancialAid.Entities.AwardLetter3 inputAwardLetter;
        ...
        private AwardLetter3EntityToDtoAdapter awardLetterEntityToDtoAdapter;
        ...
        public void Initialize()
        {
            ...
            inputAwardLetter = new Domain.FinancialAid.Entities.AwardLetter3(studentId, inputAwardYear)
            {
            ...
            awardLetterEntityToDtoAdapter = new AwardLetter3EntityToDtoAdapter(adapterRegistryMock.Object, loggerMock.Object);
        }

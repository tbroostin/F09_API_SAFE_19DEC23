...
using Ellucian.Colleague.Coordination.Sudent.Services;
using Ellucian.Colleague.Domain.Sudent.Entities;
using Ellucian.Colleague.Domain.Sudent.Repositories;
...
namespace Ellucian.Colleague.Coordination.Sudent.Tests.Services
{    
    [TestClass]

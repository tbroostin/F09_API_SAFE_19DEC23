...
namespace Ellucian.Colleague.Coordination.HumanResources.Services
{
    public interface IHumanResourceDemographicsService
    {
        ...
        Task<IEnumerable<HumanResourceDemographics>> GetHumanResourceDemographics2Async(string effectivePersonId = null);

        Task<HumanResourceDemographics> GetSpecificHumanResourceDemographicsAsync(string id);

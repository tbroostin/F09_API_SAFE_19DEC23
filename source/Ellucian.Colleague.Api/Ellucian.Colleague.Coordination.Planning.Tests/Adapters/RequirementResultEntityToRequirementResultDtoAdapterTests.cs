...
namespace Ellucian.Colleague.Coordination.Planning.Tests.Adapters
{
    ...
    [TestClass]
    public class RequirementResultEntityToRequirementResultDtoAdapterTests : CurrentUserSetup
    {
        ...
        [TestMethod]
        public void RequirementResultDtoAdapter()
        {
            ...
            var adapter = new RequirementResultDtoAdapter(adapterRegistry, logger);

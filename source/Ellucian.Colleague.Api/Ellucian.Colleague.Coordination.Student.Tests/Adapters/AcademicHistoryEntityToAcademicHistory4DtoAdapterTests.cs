...
{
    [TestClass]
    public class AcademicHistoryEntityToAcademicHistory4DtoAdapterTests
    {
        Ellucian.Colleague.Domain.Student.Entities.AcademicHistory academicHistoryEntity;
        AcademicHistoryEntityToAcademicHistory4DtoAdapter adapter;
        ...
        public async void Initialize()
        {
            ...
            adapter = new AcademicHistoryEntityToAcademicHistory4DtoAdapter(adapterRegistry, loggerMock.Object);
        }

        [TestMethod]
        public void AcademicHistoryEntity4Adapter_SuccessfullyConvertsToDto()
        {
            AcademicHistory4 academicHistoryDto = adapter.MapToType(academicHistoryEntity);

...
{
    [TestClass]
    public class AcademicTermEntityToAcademicTermDto3AdapterTests
    {
        Ellucian.Colleague.Domain.Student.Entities.AcademicTerm academicTermEntity;
        AcademicTermEntityToAcademicTerm3DtoAdapter adapter;
        ...
        public async void Initialize()
        {
            ...
            var academicCreditAdapter = new AcademicCreditEntityToAcademicCredit2DtoAdapter(adapterRegistry, loggerMock.Object);
            adapterRegistryMock.Setup(reg => reg.GetAdapter<Ellucian.Colleague.Domain.Student.Entities.AcademicCredit, Dtos.Student.AcademicCredit2>()).Returns(academicCreditAdapter);
            ...
            adapter = new AcademicTermEntityToAcademicTerm3DtoAdapter(adapterRegistry, loggerMock.Object);
        }

        [TestMethod]
        public void AcademicTermEntityAdapter_ConvertsAllProperties()
        {
            AcademicTerm3 academicTermDto = adapter.MapToType(academicTermEntity);

...
{
    [TestClass]
    public class DegreePlan4DtoToDegreePlanEntityAdapterTests
    {
        ...
        public void Initialize()
        {
            ...
            var degreePlanDtoAdapter = new DegreePlanDto4Adapter(adapterRegistryMock.Object, loggerMock.Object);

            // Create the DegreePlan3 DTO
            degreePlanDto = new DegreePlan4();
            degreePlanDto.Id = planId;
            degreePlanDto.PersonId = personId;
            degreePlanDto.Version = 1;
            var degreePlanTerm1 = new DegreePlanTerm4();
            degreePlanTerm1.TermId = "2012/FA";
            degreePlanTerm1.PlannedCourses = new List<PlannedCourse4>(){
                new PlannedCourse4(){CourseId = "111", Credits = 3.0m},
                new PlannedCourse4(){CourseId = "222", SectionId = "10001", Credits = 4.0m},
                new PlannedCourse4(){CourseId = "333", SectionId = "333", Credits = 3.0m, GradingType = Dtos.Student.GradingType.PassFail, SectionWaitlistStatus = WaitlistStatus.Active},
                new PlannedCourse4(){CourseId = "444", SectionId = "444", Credits = 3.0m, GradingType = Dtos.Student.GradingType.Audit, SectionWaitlistStatus = WaitlistStatus.PermissionToRegister, IsProtected = true, AddedBy = "SMITH", AddedOn = DateTimeOffset.Now }
            };
            var degreePlanTerm2 = new DegreePlanTerm4();
            degreePlanTerm2.TermId = "2013/FA";
            degreePlanTerm2.PlannedCourses = new List<PlannedCourse4>(){
                new PlannedCourse4(){CourseId = "111", Credits = 3.0m},
                new PlannedCourse4(){CourseId = "222", SectionId = "10001", Credits = 4.0m}};
            ...
            degreePlanDto.Terms = new List<DegreePlanTerm4>();
            degreePlanDto.NonTermPlannedCourses = new List<PlannedCourse4>();
            degreePlanDto.Terms.Add(degreePlanTerm1);
            degreePlanDto.Terms.Add(degreePlanTerm2);
            degreePlanDto.NonTermPlannedCourses.Add(new PlannedCourse4() { CourseId = "333", SectionId = "3332", Credits = 2.0m });
            degreePlanDto.NonTermPlannedCourses.Add(new PlannedCourse4() { CourseId = "444", SectionId = "4442", Credits = 2.0m, GradingType = Dtos.Student.GradingType.PassFail, SectionWaitlistStatus = WaitlistStatus.Active });
            degreePlanDto.NonTermPlannedCourses.Add(new PlannedCourse4() { CourseId = "555", SectionId = "5552", Credits = 2.0m, GradingType = Dtos.Student.GradingType.Audit, SectionWaitlistStatus = WaitlistStatus.PermissionToRegister });
            degreePlanDto.NonTermPlannedCourses.Add(new PlannedCourse4() { CourseId = "666", SectionId = "6662", Credits = 2.0m, GradingType = Dtos.Student.GradingType.Audit, SectionWaitlistStatus = WaitlistStatus.NotWaitlisted, IsProtected = true, AddedBy = "SMITH", AddedOn = DateTimeOffset.Now });
            ...
            degreePlanDto.RestrictedNotes = new List<DegreePlanNote2>()
            {
                new DegreePlanNote2() {Id = 4, PersonId = "567", Date = date1, Text = "restricted note1"},
                new DegreePlanNote2() {Id = 0, PersonId = "890", Text = "new restricted note2"}
            };
            degreePlanEntity = degreePlanDtoAdapter.MapToType(degreePlanDto);
        }

        [TestMethod]
        public void DegreePlanDto4Adapter_Id()
        {
            Assert.AreEqual(planId, degreePlanEntity.Id);
        }

        [TestMethod]
        public void DegreePlanDto4Adapter_PersonId()
        {
            Assert.AreEqual(personId, degreePlanEntity.PersonId);
        }

        [TestMethod]
        public void DegreePlanDto4Adapter_Version()
        {
            Assert.AreEqual(1, degreePlanEntity.Version);
        }

        [TestMethod]
        public void DegreePlanDto4Adapter_PlannedCoursesInTerm()
        {
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_PlannedCoursesNoTerm()
        {
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_PlannedCourseNonTermProperties()
        {
            ...
            Assert.AreEqual(dtoPlannedCourse.IsProtected, plannedCourse.IsProtected);
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_PlannedCourseProperties()
        {
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_PlannedCourseMessagesNotConverted()
        {
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_Approvals()
        {
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_Notes()
        {
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_RestrictedNotes()
        {
            Assert.AreEqual(2, degreePlanEntity.RestrictedNotes.Count());
            var note = degreePlanEntity.RestrictedNotes.ElementAt(0);
            Assert.AreEqual(4, note.Id);
            Assert.AreEqual("567", note.PersonId);
            Assert.AreEqual(date1, note.Date);
            Assert.AreEqual("restricted note1", note.Text);
            note = degreePlanEntity.RestrictedNotes.ElementAt(1);
            Assert.AreEqual(0, note.Id);
            Assert.AreEqual("new restricted note2", note.Text);
        }

        [TestMethod]
        public void DegreePlanDto4Adapter_GradingType()
        {
        ...
        [TestMethod]
        public void DegreePlanDto4Adapter_WaitlistStatus()
        {

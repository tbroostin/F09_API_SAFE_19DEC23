...
{
    [TestClass]
    public class DegreePlanEntitytoDegreePlan3DtoAdapterTests
    {
        int planId = 1;
        ...
        public void Initialize()
        {
            ...
            var degreePlanAdapter = new DegreePlanEntity3Adapter(adapterRegistryMock.Object, loggerMock.Object);
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_Id()
        {
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_PersonId()
        {
            Assert.AreEqual(personId, degreePlanDto.PersonId);
        }

        [TestMethod]
        public void DegreePlanEntity3Adapter_Version()
        {
            Assert.AreEqual(2, degreePlanDto.Version);
        }

        [TestMethod]
        public void DegreePlanEntity3Adapter_TermCourses()
        {
            Assert.AreEqual(1, degreePlanDto.Terms.Count());
        }

        [TestMethod]
        public void DegreePlanEntity3Adapter_CoursesInATerm()
        {
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_PlannedCourseProperties()
        {
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_PlannedCourseWarnings()
        {
            var tc = degreePlanDto.Terms.ElementAt(0);
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_NonTermPlannedCourse()
        {
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_NonTerm_PlannedCourseWarnings()
        {
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_Approvals()
        {
        ...
        [TestMethod]
        public void DegreePlanEntity3Adapter_Notes()
        {

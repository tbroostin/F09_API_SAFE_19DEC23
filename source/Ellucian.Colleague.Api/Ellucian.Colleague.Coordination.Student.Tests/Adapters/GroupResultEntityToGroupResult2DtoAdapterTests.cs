...
{
    [TestClass]
    public class GroupResultEntityToGroupResult2DtoAdapterTests
    {
        public Ellucian.Colleague.Domain.Student.Entities.Requirements.GroupResult groupResultEntity;
        public GroupResult2 groupResultDto;
        public GroupResultEntityToGroupResult2DtoAdapter adapter;
        ...
        public void Initialize()
        {
            ...
            adapter = new GroupResultEntityToGroupResult2DtoAdapter(adapterRegistryMock.Object, loggerMock.Object);

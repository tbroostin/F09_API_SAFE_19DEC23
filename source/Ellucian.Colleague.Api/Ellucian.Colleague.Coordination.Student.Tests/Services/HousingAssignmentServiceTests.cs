...
{
    [TestClass]
    public class HousingAssignmentServiceTests_V10
    {
        [TestClass]
        public class HousingAssignmentServiceTests_GETALL_GETBYID : StudentUserFactory
        {
            ...
            private void InitializeTestMock()
            {
                ...
                housingAssignmentRepositoryMock.Setup(h => h.GetHousingAssignmentsAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>())).ReturnsAsync(domainHousingAssignmentsTuple);
            ...
            public async Task HousingAssignmentService_GetHousingAssignmentsAsync_PermissionsException()
            {
                ...
                await housingAssignmentService.GetHousingAssignmentsAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>());
            }
            ...
            {
                housingAssignmentRepositoryMock.Setup(h => h.GetHousingAssignmentsAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>())).Throws(new Exception());
                await housingAssignmentService.GetHousingAssignmentsAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>());
            }
            ...
            {
                var result = await housingAssignmentService.GetHousingAssignmentsAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>());

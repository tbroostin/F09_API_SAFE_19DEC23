...
namespace Ellucian.Colleague.Coordination.Student.Adapters
{
    ...
    /// </summary>
    public class DegreePlanDto2Adapter : BaseAdapter<Dtos.Student.DegreePlans.DegreePlan2, Domain.Student.Entities.DegreePlans.DegreePlan>
    {
        public DegreePlanDto2Adapter(IAdapterRegistry adapterRegistry, ILogger logger) : base(adapterRegistry, logger) { }

        // Since AutoMapper cannot be used here, inherit from BaseAdapter and override the MapToType method for custom mapping
        public override Domain.Student.Entities.DegreePlans.DegreePlan MapToType(Dtos.Student.DegreePlans.DegreePlan2 Source)
        {

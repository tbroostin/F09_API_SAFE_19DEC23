...
namespace Ellucian.Colleague.Coordination.Student.Adapters
{
    ...
    public class DegreePlanEntity3Adapter : BaseAdapter<Domain.Student.Entities.DegreePlans.DegreePlan, Dtos.Student.DegreePlans.DegreePlan3>
    {
        public DegreePlanEntity3Adapter(IAdapterRegistry adapterRegistry, ILogger logger) : base(adapterRegistry, logger) { }

        public override Dtos.Student.DegreePlans.DegreePlan3 MapToType(Domain.Student.Entities.DegreePlans.DegreePlan Source)
        {
            var degreePlanDto = new Dtos.Student.DegreePlans.DegreePlan3();
            ...
            degreePlanDto.Terms = new List<Dtos.Student.DegreePlans.DegreePlanTerm3>();
            degreePlanDto.NonTermPlannedCourses = new List<Dtos.Student.DegreePlans.PlannedCourse3>();
            ...
            {
                Dtos.Student.DegreePlans.DegreePlanTerm3 planTerm = new Dtos.Student.DegreePlans.DegreePlanTerm3();
                planTerm.TermId = term;
                planTerm.PlannedCourses = new List<Dtos.Student.DegreePlans.PlannedCourse3>();
                ...
                if (plannedcourses != null)
                {
                    foreach (var plannedcourse in plannedcourses)
                    {
                        ...
                        var plannedCourseDto = new Dtos.Student.DegreePlans.PlannedCourse3() 
                        { 

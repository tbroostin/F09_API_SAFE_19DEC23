...
{
    public class StudentEntityToStudentBatch2DtoAdapter : AutoMapperAdapter<Ellucian.Colleague.Domain.Student.Entities.Student, Ellucian.Colleague.Dtos.Student.StudentBatch2>
    {
        public StudentEntityToStudentBatch2DtoAdapter(IAdapterRegistry adapterRegistry, ILogger logger)

...
{
    public class SubRequirementResultEntityToSubRequirementResult3DtoAdapter : BaseAdapter<Ellucian.Colleague.Domain.Student.Entities.Requirements.SubrequirementResult, Ellucian.Colleague.Dtos.Student.Requirements.SubrequirementResult3>
    {
        public SubRequirementResultEntityToSubRequirementResult3DtoAdapter(IAdapterRegistry adapterRegistry, ILogger logger) : base(adapterRegistry, logger) { }

        public override Ellucian.Colleague.Dtos.Student.Requirements.SubrequirementResult3 MapToType(Ellucian.Colleague.Domain.Student.Entities.Requirements.SubrequirementResult Source)
        {
            var subrequirementResult = new Ellucian.Colleague.Dtos.Student.Requirements.SubrequirementResult3();
            ...
            subrequirementResult.GroupResults = new List<Ellucian.Colleague.Dtos.Student.Requirements.GroupResult3>();

            var groupResultDtoAdapter = new GroupResultEntityToGroupResult3DtoAdapter(adapterRegistry, logger);

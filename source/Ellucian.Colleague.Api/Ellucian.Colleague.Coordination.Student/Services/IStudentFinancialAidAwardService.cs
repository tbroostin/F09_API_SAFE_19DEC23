...
namespace Ellucian.Colleague.Coordination.Student.Services
{
    ...
    public interface IStudentFinancialAidAwardService : IBaseService
    {
        ...
        Task<Dtos.StudentFinancialAidAward2> GetById2Async(string id, bool restricted, bool bypassCache = false);
        Task<Tuple<IEnumerable<Dtos.StudentFinancialAidAward2>, int>> Get2Async(int offset, int limit, Dtos.StudentFinancialAidAward2 criteria, string personFilterValue = "", bool bypassCache = false, bool restricted = false);
    }
}
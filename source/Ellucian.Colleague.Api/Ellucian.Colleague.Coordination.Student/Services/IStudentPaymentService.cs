...
namespace Ellucian.Colleague.Coordination.Student.Services
{
    ...
    public interface IStudentPaymentService : IBaseService
    {
        ...
        Task<Tuple<IEnumerable<Dtos.StudentPayment2>, int>> GetAsync2(int offset, int limit, bool bypassCache, string personId = "", string academicPeriod = "", string fundSource = "", string chargeType = "", string fundDestination = "", string usage = "");

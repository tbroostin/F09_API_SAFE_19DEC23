...
//     Last generated on 5/4/2022 8:42:49 AM by user asainju2
//
//     Type: ENTITY
...
namespace Ellucian.Colleague.Data.Base.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "5/4/2022 8:42:49 AM", User = "asainju2")]
	...
	public class EdmExtensions : IColleagueEntity
	{
		...
		/// <summary>
		/// CDD Name: EDME.PROCESS.ARGUMENTS
		/// </summary>
		[DataMember(Order = 39, Name = "EDME.PROCESS.ARGUMENTS")]
		public List<string> EdmeProcessArguments { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.CURRENT.USER.PATH
		/// </summary>
		[DataMember(Order = 40, Name = "EDME.CURRENT.USER.PATH")]
		public string EdmeCurrentUserPath { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.PROCESS.DESC
		/// </summary>
		[DataMember(Order = 41, Name = "EDME.PROCESS.DESC")]
		public string EdmeProcessDesc { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.API.DOMAIN
		/// </summary>
		[DataMember(Order = 42, Name = "EDME.API.DOMAIN")]
		public string EdmeApiDomain { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.HTTP.METHOD.DESC
		/// </summary>
		[DataMember(Order = 43, Name = "EDME.HTTP.METHOD.DESC")]
		public List<string> EdmeHttpMethodDesc { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.PROMPT.RESPONSE.TEXT
		/// </summary>
		[DataMember(Order = 44, Name = "EDME.PROMPT.RESPONSE.TEXT")]
		public List<string> EdmePromptResponseText { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.PROMPT.RESPONSE.DFLT
		/// </summary>
		[DataMember(Order = 45, Name = "EDME.PROMPT.RESPONSE.DFLT")]
		public List<string> EdmePromptResponseDflt { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.PROMPT.RESPONSE.OPTS
		/// </summary>
		[DataMember(Order = 46, Name = "EDME.PROMPT.RESPONSE.OPTS")]
		public List<string> EdmePromptResponseOpts { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.PROMPT.RESPONSE.TITLE
		/// </summary>
		[DataMember(Order = 47, Name = "EDME.PROMPT.RESPONSE.TITLE")]
		public List<string> EdmePromptResponseTitle { get; set; }
		
		/// <summary>
		/// CDD Name: EDME.HTTP.METHOD.SUMMARY
		/// </summary>
		[DataMember(Order = 49, Name = "EDME.HTTP.METHOD.SUMMARY")]
		public List<string> EdmeHttpMethodSummary { get; set; }
		...
		/// </summary>
		[DataMember]
		public List<EdmExtensionsEdmePreparedResponses> EdmePreparedResponsesEntityAssociation { get; set; }
		...
		{	
			...
			if(EdmeHttpMethods != null)
			{
				...
				if (EdmeHttpMethodDesc !=null && EdmeHttpMethodDesc.Count > numEdmeMethods) numEdmeMethods = EdmeHttpMethodDesc.Count;
				if (EdmeHttpMethodSummary !=null && EdmeHttpMethodSummary.Count > numEdmeMethods) numEdmeMethods = EdmeHttpMethodSummary.Count;
				...
				for (int i = 0; i < numEdmeMethods; i++)
				{
					...
					string value2 = "";
					if (EdmeHttpMethodDesc != null && i < EdmeHttpMethodDesc.Count)
					{
						value2 = EdmeHttpMethodDesc[i];
					}


					string value3 = "";
					if (EdmeHttpMethodSummary != null && i < EdmeHttpMethodSummary.Count)
					{
						value3 = EdmeHttpMethodSummary[i];
					}

					EdmeMethodsEntityAssociation.Add(new EdmExtensionsEdmeMethods( value0, value1, value2, value3));
				}
			}
			...
			// EntityAssociation Name: EDME.PREPARED.RESPONSES
			
			EdmePreparedResponsesEntityAssociation = new List<EdmExtensionsEdmePreparedResponses>();
			// Set max length to the count of controller when initializing.
			//Update max length if any of the association members has higher length than controller length
			if(EdmePromptResponseText != null)
			{
				int numEdmePreparedResponses = EdmePromptResponseText.Count;
				if (EdmePromptResponseDflt !=null && EdmePromptResponseDflt.Count > numEdmePreparedResponses) numEdmePreparedResponses = EdmePromptResponseDflt.Count;
				if (EdmePromptResponseOpts !=null && EdmePromptResponseOpts.Count > numEdmePreparedResponses) numEdmePreparedResponses = EdmePromptResponseOpts.Count;
				if (EdmePromptResponseTitle !=null && EdmePromptResponseTitle.Count > numEdmePreparedResponses) numEdmePreparedResponses = EdmePromptResponseTitle.Count;

				for (int i = 0; i < numEdmePreparedResponses; i++)
				{

					string value0 = "";
					if (EdmePromptResponseText != null && i < EdmePromptResponseText.Count)
					{
						value0 = EdmePromptResponseText[i];
					}


					string value1 = "";
					if (EdmePromptResponseDflt != null && i < EdmePromptResponseDflt.Count)
					{
						value1 = EdmePromptResponseDflt[i];
					}


					string value2 = "";
					if (EdmePromptResponseOpts != null && i < EdmePromptResponseOpts.Count)
					{
						value2 = EdmePromptResponseOpts[i];
					}


					string value3 = "";
					if (EdmePromptResponseTitle != null && i < EdmePromptResponseTitle.Count)
					{
						value3 = EdmePromptResponseTitle[i];
					}

					EdmePreparedResponsesEntityAssociation.Add(new EdmExtensionsEdmePreparedResponses( value0, value1, value2, value3));
				}
			}
	...
	public class EdmExtensionsEdmeMethods
	{
		...
		public string EdmeHttpMethodDescAssocMember;	
		public string EdmeHttpMethodSummaryAssocMember;	
		public EdmExtensionsEdmeMethods() {}
		public EdmExtensionsEdmeMethods(
			string inEdmeHttpMethods,
			string inEdmeHttpPermissions,
			string inEdmeHttpMethodDesc,
			string inEdmeHttpMethodSummary)
		{
			EdmeHttpMethodsAssocMember = inEdmeHttpMethods;
			EdmeHttpPermissionsAssocMember = inEdmeHttpPermissions;
			EdmeHttpMethodDescAssocMember = inEdmeHttpMethodDesc;
			EdmeHttpMethodSummaryAssocMember = inEdmeHttpMethodSummary;
		}
	}
	...
	[Serializable]
	public class EdmExtensionsEdmePreparedResponses
	{
		public string EdmePromptResponseTextAssocMember;	
		public string EdmePromptResponseDfltAssocMember;	
		public string EdmePromptResponseOptsAssocMember;	
		public string EdmePromptResponseTitleAssocMember;	
		public EdmExtensionsEdmePreparedResponses() {}
		public EdmExtensionsEdmePreparedResponses(
			string inEdmePromptResponseText,
			string inEdmePromptResponseDflt,
			string inEdmePromptResponseOpts,
			string inEdmePromptResponseTitle)
		{
			EdmePromptResponseTextAssocMember = inEdmePromptResponseText;
			EdmePromptResponseDfltAssocMember = inEdmePromptResponseDflt;
			EdmePromptResponseOptsAssocMember = inEdmePromptResponseOpts;
			EdmePromptResponseTitleAssocMember = inEdmePromptResponseTitle;
		}
	}
}
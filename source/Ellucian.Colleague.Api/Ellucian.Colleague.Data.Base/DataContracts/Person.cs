...
//     Last generated on 11/9/2021 11:06:46 AM by user cindystair
//
//     Type: ENTITY
//     Entity: PERSON
//     Application: CORE
...
namespace Ellucian.Colleague.Data.Base.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "11/9/2021 11:06:46 AM", User = "cindystair")]
	...
	public class Person : IColleagueGuidEntity
	{
		...
		/// <summary>
		/// CDD Name: PERSONAL.PHONE.TEXT.AUTH
		/// </summary>
		[DataMember(Order = 246, Name = "PERSONAL.PHONE.TEXT.AUTH")]
		public List<string> PersonalPhoneTextAuth { get; set; }
		...
		{	
			...
			if(PersonalPhoneNumber != null)
			{
				...
				if (PersonalPhoneTextAuth !=null && PersonalPhoneTextAuth.Count > numPerphone) numPerphone = PersonalPhoneTextAuth.Count;
				...
				for (int i = 0; i < numPerphone; i++)
				{
					...
					string value3 = "";
					if (PersonalPhoneTextAuth != null && i < PersonalPhoneTextAuth.Count)
					{
						value3 = PersonalPhoneTextAuth[i];
					}

					PerphoneEntityAssociation.Add(new PersonPerphone( value0, value1, value2, value3));
				}
			}
	...
	public class PersonPerphone
	{
			...
			string inPersonalPhoneTextAuth)
		{
			...
			PersonalPhoneTextAuthAssocMember = inPersonalPhoneTextAuth;
		}
	}
}
...
//     Last generated on 2/28/2023 2:30:03 PM by user dvetk-srm
//
//     Type: CTX
...
namespace Ellucian.Colleague.Data.Base.Transactions
{
	...
	{
		[DataMember]
		[SctrqDataMember(AppServerName = "SPEC.COLUMN.NAMES", InBoundData = true)]
		public string SpecColumnNames { get; set; }

		[DataMember]
		[SctrqDataMember(AppServerName = "SPEC.COLUMN.PATHS", InBoundData = true)]
		public string SpecColumnPaths { get; set; }
	}

	[GeneratedCodeAttribute("Colleague Data Contract Generator", "1.2")]
	[DataContract]
	[ColleagueDataContract(ColleagueId = "PROCESS.SCREEN.API", GeneratedDateTime = "2/28/2023 2:30:03 PM", User = "dvetk-srm")]
	...
	public class ProcessScreenApiRequest
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "Grp:SPEC.COLUMN.NAMES", InBoundData = true)]
		public List<SpecColumnData> SpecColumnData { get; set; }
		...
		{	
			...
			SpecColumnData = new List<SpecColumnData>();
		}
	}

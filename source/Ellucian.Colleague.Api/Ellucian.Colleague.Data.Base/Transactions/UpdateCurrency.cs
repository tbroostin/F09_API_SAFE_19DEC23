...
//     Last generated on 3/29/2019 11:44:30 AM by user bsf1
//
//     Type: CTX
//     Transaction ID: UPDATE.CURRENCY
//     Application: CF
//     Environment: dvcoll
//
...
{
	[DataContract]
	public class CurrencyConvErrors
	{
		[DataMember]
	...
	[DataContract]
	[ColleagueDataContract(ColleagueId = "UPDATE.CURRENCY", GeneratedDateTime = "3/29/2019 11:44:30 AM", User = "bsf1")]
	...
	public class UpdateCurrencyRequest
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "CURRENCIES", InBoundData = true)]        
	...
	public class UpdateCurrencyResponse
	{
		...
		public List<CurrencyConvErrors> CurrencyConvErrors { get; set; }

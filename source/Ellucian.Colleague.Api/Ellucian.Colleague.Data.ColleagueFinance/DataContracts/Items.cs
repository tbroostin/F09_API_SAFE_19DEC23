...
//     Last generated on 3/9/2020 5:17:30 PM by user asainju1
//
//     Type: ENTITY
//     Entity: ITEMS
//     Application: CF
...
namespace Ellucian.Colleague.Data.ColleagueFinance.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "3/9/2020 5:17:30 PM", User = "asainju1")]
	...
	public class Items : IColleagueEntity
	{
		...
		/// <summary>
		/// CDD Name: ITM.INITIATOR
		/// </summary>
		[DataMember(Order = 2, Name = "ITM.INITIATOR")]
		public string ItmInitiator { get; set; }
		...
		/// <summary>
		/// CDD Name: ITM.FIXED.ASSETS.FLAG
		/// </summary>
		[DataMember(Order = 6, Name = "ITM.FIXED.ASSETS.FLAG")]
		public string ItmFixedAssetsFlag { get; set; }
		...
		/// <summary>
		/// CDD Name: ITM.TAX.CODES
		/// </summary>
		[DataMember(Order = 9, Name = "ITM.TAX.CODES")]
		public List<string> ItmTaxCodes { get; set; }
		...
		/// CDD Name: ITM.VOU.ID
		/// </summary>
		[DataMember(Order = 49, Name = "ITM.VOU.ID")]
		public string ItmVouId { get; set; }

...
//     Last generated on 7/25/2022 6:27:52 PM by user vaidyas
//
//     Type: ENTITY
//     Entity: REQUISITIONS
//     Application: CF
...
namespace Ellucian.Colleague.Data.ColleagueFinance.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "7/25/2022 6:27:52 PM", User = "vaidyas")]
	...
	public class Requisitions : IColleagueGuidEntity
	{
		...
		/// <summary>
		/// CDD Name: REQ.CONF.EMAIL.ADDRESSES
		/// </summary>
		[DataMember(Order = 84, Name = "REQ.CONF.EMAIL.ADDRESSES")]
		public List<string> ReqConfEmailAddresses { get; set; }
		
		/// <summary>
		/// CDD Name: REQ.INTG.TYPE
		/// </summary>
		[DataMember(Order = 85, Name = "REQ.INTG.TYPE")]
		public string ReqIntgType { get; set; }
		
		/// <summary>
		/// CDD Name: REQ.REFERENCE.NO
		/// </summary>
		[DataMember(Order = 86, Name = "REQ.REFERENCE.NO")]
		public List<string> ReqReferenceNo { get; set; }
		
		/// <summary>
		/// CDD Name: REQ.RETURN.FLAG
		/// </summary>
		[DataMember(Order = 87, Name = "REQ.RETURN.FLAG")]
		public string ReqReturnFlag { get; set; }

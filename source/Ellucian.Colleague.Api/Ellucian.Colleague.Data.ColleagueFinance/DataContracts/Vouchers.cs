...
//     Last generated on 7/7/2022 12:12:07 PM by user vaidyas
//
//     Type: ENTITY
//     Entity: VOUCHERS
//     Application: CF
...
namespace Ellucian.Colleague.Data.ColleagueFinance.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "7/7/2022 12:12:07 PM", User = "vaidyas")]
	...
	public class Vouchers : IColleagueGuidEntity
	{
		...
		/// <summary>
		/// CDD Name: VOU.CONF.EMAIL.ADDRESSES
		/// </summary>
		[DataMember(Order = 113, Name = "VOU.CONF.EMAIL.ADDRESSES")]
		public List<string> VouConfEmailAddresses { get; set; }
		
		/// <summary>
		/// CDD Name: VOU.RETURN.FLAG
		/// </summary>
		[DataMember(Order = 114, Name = "VOU.RETURN.FLAG")]
		public string VouReturnFlag { get; set; }

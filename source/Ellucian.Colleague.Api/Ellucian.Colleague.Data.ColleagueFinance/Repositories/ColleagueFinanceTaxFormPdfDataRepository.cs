    ...
    public class ColleagueFinanceTaxFormPdfDataRepository : BaseColleagueRepository, IColleagueFinanceTaxFormPdfDataRepository
    {
        ...
        public async Task<Form1099MIPdfData> GetForm1099MiPdfDataAsync(string personId, string recordId)
        {
            ...
            try
            {
                ...
                {
                    throw new NullReferenceException("1099Mi Detail Record cannot be null.");
                }
                ...
                {
                    string transmitterId = null, transmitterName = null, transmitterAddress1 = null, transmitterCity = null, transmitterState = null, transmitterZip = null,
                    ...
                    {
                        throw new NullReferenceException("1099Mi Repos cannot be null.");
                    }
                    ...
                    {
                        var currentTransmitterIndex = parm1099MIContract.P1099miTTransmitterId.FindIndex(x => x == transmitterId);
                        if (currentTransmitterIndex != -1)
                        {
                            transmitterName = currentTransmitterIndex < parm1099MIContract.P1099miTCoName.Count ? parm1099MIContract.P1099miTCoName[currentTransmitterIndex] : "";
                            transmitterAddress1 = currentTransmitterIndex < parm1099MIContract.P1099miTCoAddr.Count ? parm1099MIContract.P1099miTCoAddr[currentTransmitterIndex] : "";
                            transmitterCity = currentTransmitterIndex < parm1099MIContract.P1099miTCoCity.Count ? parm1099MIContract.P1099miTCoCity[currentTransmitterIndex] : "";
                            transmitterState = currentTransmitterIndex < parm1099MIContract.P1099miTState.Count ? parm1099MIContract.P1099miTState[currentTransmitterIndex] : "";
                            transmitterZip = currentTransmitterIndex < parm1099MIContract.P1099miTZip.Count ? parm1099MIContract.P1099miTZip[currentTransmitterIndex] : "";
                    ...
                    else
                    {
                        ...
                        if (transmitterAddressLines != null)
                        {
                            ...
                            transmitterAddress2 = transmitterAddressLines.ElementAtOrDefault(0) ?? "";
                            if (!string.IsNullOrEmpty(transmitterAddressLines.ElementAtOrDefault(1)))
                            {
                                transmitterAddress2 += " " + transmitterAddressLines.ElementAtOrDefault(1);
                            }

                            // Combine address lines 3 and 4
                            transmitterAddress3 = transmitterAddressLines.ElementAtOrDefault(2) ?? "";
                            if (!string.IsNullOrEmpty(transmitterAddressLines.ElementAtOrDefault(3)))
                            {
                                transmitterAddress3 += " " + transmitterAddressLines.ElementAtOrDefault(3);
                            }
                        }
                    }
                    ...
                    string recipientName = null, recipientSecondName = null, recipientAddress1 = null, recipientAddress2 = null, recipientAddress3 = null, recipientPhone = null, recipientIdentificationNumber = null;
                    ...
                    {
                        //Find out the index of the current Taxform Record
                        var currentIndex = taxYearRecord.TfmySubmitSeqNos.FindIndex(x => x == currentMiDetailRecord.TmidtlrRefId);
                        recipientName = currentIndex < miReposContract.TfmirCertifyName.Count ? miReposContract.TfmirCertifyName[currentIndex] : "";
                        recipientSecondName = currentIndex < miReposContract.TfmirCertifySecondName.Count ? miReposContract.TfmirCertifySecondName[currentIndex] : "";
                        recipientAddress1 = currentIndex < miReposContract.TfmirCertifyAddress.Count ? miReposContract.TfmirCertifyAddress[currentIndex] : "";
                        recipientAddress2 = (currentIndex < miReposContract.TfmirCertifyAddressLine2.Count ? miReposContract.TfmirCertifyAddressLine2[currentIndex] : "") + " " + (currentIndex < miReposContract.TfmirCertifyAddressLine3.Count ? miReposContract.TfmirCertifyAddressLine3[currentIndex] : "");
                        recipientAddress3 = currentIndex < miReposContract.TfmirCertifyCity.Count ? miReposContract.TfmirCertifyCity[currentIndex] + " , " + miReposContract.TfmirCertifyState[currentIndex] + " " + miReposContract.TfmirCertifyZip[currentIndex] : "";
                        recipientIdentificationNumber = currentIndex < miReposContract.TfmirCertifyTin.Count ? miReposContract.TfmirCertifyTin[currentIndex] : "";
                        directResale = currentIndex < miReposContract.TfmirCertifyDirectResale.Count ? miReposContract.TfmirCertifyDirectResale[currentIndex] : "";
                    }

                    //Assigning the State-Payer Ein 
                    string statePayerEin = null;
                    ...
                    if (states1099OrgContract != null)
                    {
                        ...
                        {
                            statePayerEin = currentMiDetailRecord.TmidtlrStateId + " " + states1099OrgContract.St1099OrgEin;
                        }
                    }
                    // Instantiate the domain entity.
                    ...
                    domainEntity1099Mi.IsDirectResale = directResale == "Y" ? "X" : "";
                    //payers ein
                    domainEntity1099Mi.PayersEin = miReposContract.TfmirEin;
                    // Assign the payer address lines.
                    domainEntity1099Mi.PayerAddressLine1 = transmitterAddress1 ?? "";
                    domainEntity1099Mi.PayerAddressLine2 = transmitterAddress2 ?? "";
                    domainEntity1099Mi.PayerAddressLine3 = transmitterAddress3 ?? "";

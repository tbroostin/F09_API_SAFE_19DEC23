...
//     Last generated on 3/31/2020 9:01:29 AM by user asainju1
//
//     Type: CTX
...
namespace Ellucian.Colleague.Data.ColleagueFinance.Transactions
{
	...
	[DataContract]
	[ColleagueDataContract(ColleagueId = "CREATE.UPDATE.VENDOR", GeneratedDateTime = "3/31/2020 9:01:29 AM", User = "asainju1")]
	...
	public class CreateUpdateVendorRequest
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "TAX.ID", InBoundData = true)]        
		public string TaxId { get; set; }

		[DataMember]
		[SctrqDataMember(AppServerName = "TAX.FORM", InBoundData = true)]        

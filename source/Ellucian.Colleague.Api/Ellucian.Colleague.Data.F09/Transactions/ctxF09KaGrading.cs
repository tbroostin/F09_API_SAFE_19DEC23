...
//     Last generated on 7/7/2019 12:46:34 PM by user tshadley
//
//     Type: CTX
...
namespace Ellucian.Colleague.Data.F09.Transactions
{
	...
	public class Questions
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "AL.Q.HEADER", InBoundData = true, OutBoundData = true)]
	...
	[DataContract]
	[ColleagueDataContract(ColleagueId = "XCTX.F09.SS.KA.GRADING", GeneratedDateTime = "7/7/2019 12:46:34 PM", User = "tshadley")]
	...
	public class ctxF09KaGradingRequest
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "A.GRADE.EXPIRE.DATE", InBoundData = true)]        
	...
	public class ctxF09KaGradingResponse
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "A.GRADE.EXPIRE.LIMIT", OutBoundData = true)]        

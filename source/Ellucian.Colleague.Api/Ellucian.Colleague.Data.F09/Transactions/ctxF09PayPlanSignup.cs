...
//     Last generated on 8/18/2019 8:24:26 PM by user tshadley
//
//     Type: CTX
...
namespace Ellucian.Colleague.Data.F09.Transactions
{
	...
	[DataContract]
	[ColleagueDataContract(ColleagueId = "XCTX.F09.SS.PAY.PLAN.SIGNUP", GeneratedDateTime = "8/18/2019 8:24:26 PM", User = "tshadley")]
	...
	public class ctxF09PayPlanSignupRequest
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "A.PAY.METH.SELECTED", InBoundData = true)]        
		public string PayMethodSelected { get; set; }
	...
	public class ctxF09PayPlanSignupResponse
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "A.SU.OPTION.SELECTED", OutBoundData = true)]        
		public string SuOptionSelected { get; set; }
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "A.SU.INVOICE.ID", OutBoundData = true)]        
		public string SuInvoiceId { get; set; }

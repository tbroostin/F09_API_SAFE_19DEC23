...
//     Last generated on 5/28/2019 8:22:10 PM by user tshadley
//
//     Type: CTX
...
namespace Ellucian.Colleague.Data.F09.Transactions
{
	...
	[DataContract]
	[ColleagueDataContract(ColleagueId = "XCTX.F09.PDF.TRACKING.SHEET", GeneratedDateTime = "5/28/2019 8:22:10 PM", User = "tshadley")]
	...
	public class ctxF09PdfTrackingSheetResponse
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "A.DIS.PR.APPR.DATE", OutBoundData = true)]        
		public string DisPrApprDate { get; set; }

		[DataMember]
		[SctrqDataMember(AppServerName = "A.DIS.RE.APPR.DATE", OutBoundData = true)]        
		public string DisReApprDate { get; set; }

		[DataMember]
		[SctrqDataMember(AppServerName = "A.DIS.RE.WAIV.DATE", OutBoundData = true)]        
		public string DisReWaivDate { get; set; }

		[DataMember]
		[SctrqDataMember(AppServerName = "A.DIS.PR.ORAL.DATE", OutBoundData = true)]        

...
{
    [TestClass]
    public class FinancialAidApplicationRepositoryTests : BaseRepositorySetup
    {
        ...
        public FinancialAidApplicationRepository actualRepository;
        ...
        [TestClass]
        public class GetFinancialAidApplicationRepositoryTests : FinancialAidApplicationRepositoryTests
        {
            ...
            public async Task FinancialAidApplicationRepository_ArgumentNullException()
            {
            ...
            public async Task FinancialAidApplicationRepository_NoFAapplicationOutcomeRecords()
            {
                //CollectionAssert.AreEqual(expectedProfileApplications, actualProfileApplications);
            ...
            [TestMethod]
            [ExpectedException(typeof(KeyNotFoundException))]
            public async Task FinancialAidApplicationRepository_InvalidGetRecordInfoFromGuid()
            {
            ...
            [TestMethod]
            [ExpectedException(typeof(KeyNotFoundException))]
            public async Task FinancialAidApplicationRepository_IsirCalcResults_NotFound()
            {
            ...
            [TestMethod]
            public async Task FinancialAidApplicationRepository_GetByIdAsync()
            {
                //CollectionAssert.AreEqual(expectedProfileApplications, actualProfileApplications);
                var year = "2017";
                ...
                //isirFafsa = await DataReader.ReadRecordAsync<IsirFafsa>("ISIR.FAFSA", pncpId);
                //isirFafsa = await DataReader.ReadRecordAsync<IsirFafsa>("ISIR.FAFSA", recordInfo.PrimaryKey);
            ...
            [TestMethod]
            public async Task FinancialAidApplicationRepository_GetAsync_VerificationsTrue()
            {
                //CollectionAssert.AreEqual(expectedProfileApplications, actualProfileApplications);
                var year = "2017";
                var studentId = "0002020";
            ...
            [TestMethod]
            public async Task FinancialAidApplicationRepository_GetAsync_VerificationsFalse()
            {
                //CollectionAssert.AreEqual(expectedProfileApplications, actualProfileApplications);
                var year = "2017";
                var studentId = "0002020";
            ...
            [TestMethod]
            [ExpectedException(typeof(KeyNotFoundException))]
            public async Task FinancialAidApplicationRepository_GetAsync_InvalidIsirFafsa()
            {
                //CollectionAssert.AreEqual(expectedProfileApplications, actualProfileApplications);
                var year = "2017";
                var studentId = "0002020";
            ...
            [TestMethod]
            [ExpectedException(typeof(ArgumentNullException))]
            public async Task FinancialAidApplicationRepository_GetAsync_InvalidYear()
            {
                //CollectionAssert.AreEqual(expectedProfileApplications, actualProfileApplications);
                var year = "2014";
                var studentId = "0002020";
            ...
            private FinancialAidApplicationRepository BuildRepository()
            {
                
                ApiSettings apiSettings = new ApiSettings("null");
                return new FinancialAidApplicationRepository(cacheProviderMock.Object, transFactoryMock.Object, loggerMock.Object, apiSettings);
            }
        }
    }
}

...
{
    [TestClass]
    public class TaxFormStatementRepositoryTests
    {
        ...
        private TaxFormStatementRepository taxFormStatementRepository;
        ...
        private TaxFormStatementRepository BuildTaxFormStatementRepository()
        {
            ...
            return new TaxFormStatementRepository(apiSettings, cacheProviderObject, transactionFactoryObject, loggerObject);
        }
        #endregion
    }
}

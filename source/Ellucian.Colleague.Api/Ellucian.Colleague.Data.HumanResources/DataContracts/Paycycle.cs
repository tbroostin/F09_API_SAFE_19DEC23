...
//     Last generated on 9/21/2020 3:51:34 PM by user otorres
//
//     Type: ENTITY
//     Entity: PAYCYCLE
//     Application: HR
...
namespace Ellucian.Colleague.Data.HumanResources.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "9/21/2020 3:51:34 PM", User = "otorres")]
	...
	public class Paycycle : IColleagueGuidEntity
	{
		...
		/// <summary>
		/// CDD Name: PCY.SELF.SERVICE.DESC
		/// </summary>
		[DataMember(Order = 23, Name = "PCY.SELF.SERVICE.DESC")]
		public string PcySelfServiceDesc { get; set; }
		
		/// <summary>
		/// CDD Name: PCY.DISPLAY.IN.SELF.SERVICE
		/// </summary>
		[DataMember(Order = 24, Name = "PCY.DISPLAY.IN.SELF.SERVICE")]
		public string PcyDisplayInSelfService { get; set; }

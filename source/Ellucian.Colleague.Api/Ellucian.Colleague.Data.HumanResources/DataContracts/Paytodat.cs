...
//     Last generated on 10/9/2019 3:22:06 PM by user wwollnercs
//
//     Type: ENTITY
//     Entity: PAYTODAT
//     Application: HR
...
namespace Ellucian.Colleague.Data.HumanResources.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "10/9/2019 3:22:06 PM", User = "wwollnercs")]
	...
	public class Paytodat : IColleagueGuidEntity
	{
		...
		/// <summary>
		/// CDD Name: PTD.W4.NEW.FLAG
		/// </summary>
		[DataMember(Order = 182, Name = "PTD.W4.NEW.FLAG")]
		public string PtdW4NewFlag { get; set; }

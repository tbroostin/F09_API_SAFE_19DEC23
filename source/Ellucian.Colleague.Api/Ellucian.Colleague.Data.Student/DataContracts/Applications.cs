...
//     Last generated on 2/28/2020 1:29:47 PM by user balvano3
//
//     Type: ENTITY
//     Entity: APPLICATIONS
//     Application: ST
...
namespace Ellucian.Colleague.Data.Student.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "2/28/2020 1:29:47 PM", User = "balvano3")]
	...
	public class Applications : IColleagueGuidEntity
	{
		...
		/// <summary>
		/// CDD Name: APPL.INFLUENCED.TO.APPLY
		/// </summary>
		[DataMember(Order = 28, Name = "APPL.INFLUENCED.TO.APPLY")]
		public List<string> ApplInfluencedToApply { get; set; }
		...
		/// <summary>
		/// CDD Name: APPL.INTG.CAREER.GOALS
		/// </summary>
		[DataMember(Order = 68, Name = "APPL.INTG.CAREER.GOALS")]
		public List<string> ApplIntgCareerGoals { get; set; }

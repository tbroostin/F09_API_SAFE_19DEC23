...
//     Last generated on 5/10/2021 2:26:45 PM by user rebecca.rowland
//
//     Type: ENTITY
...
namespace Ellucian.Colleague.Data.Student.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "5/10/2021 2:26:45 PM", User = "rebecca.rowland")]
	...
	public class CatalogSearchDefaults : IColleagueEntity
	{
		...
		/// <summary>
		/// CDD Name: CLSD.ADV.SEARCH.ELEMENTS
		/// </summary>
		[DataMember(Order = 4, Name = "CLSD.ADV.SEARCH.ELEMENTS")]
		public List<string> ClsdAdvSearchElements { get; set; }
		
		/// <summary>
		/// CDD Name: CLSD.ADV.SEARCH.HIDE
		/// </summary>
		[DataMember(Order = 5, Name = "CLSD.ADV.SEARCH.HIDE")]
		public List<string> ClsdAdvSearchHide { get; set; }
		
		/// <summary>
		/// CDD Name: CLSD.BYPASS.AVAIL.CACHE
		/// </summary>
		[DataMember(Order = 6, Name = "CLSD.BYPASS.AVAIL.CACHE")]
		public string ClsdBypassAvailCache { get; set; }
		...
		/// </summary>
		[DataMember]
		public List<CatalogSearchDefaultsClsdAdvSearchResults> ClsdAdvSearchResultsEntityAssociation { get; set; }
		...
		{	
			...
			// EntityAssociation Name: CLSD.ADV.SEARCH.RESULTS
			
			ClsdAdvSearchResultsEntityAssociation = new List<CatalogSearchDefaultsClsdAdvSearchResults>();
			// Set max length to the count of controller when initializing.
			//Update max length if any of the association members has higher length than controller length
			if(ClsdAdvSearchElements != null)
			{
				int numClsdAdvSearchResults = ClsdAdvSearchElements.Count;
				if (ClsdAdvSearchHide !=null && ClsdAdvSearchHide.Count > numClsdAdvSearchResults) numClsdAdvSearchResults = ClsdAdvSearchHide.Count;

				for (int i = 0; i < numClsdAdvSearchResults; i++)
				{

					string value0 = "";
					if (ClsdAdvSearchElements != null && i < ClsdAdvSearchElements.Count)
					{
						value0 = ClsdAdvSearchElements[i];
					}


					string value1 = "";
					if (ClsdAdvSearchHide != null && i < ClsdAdvSearchHide.Count)
					{
						value1 = ClsdAdvSearchHide[i];
					}

					ClsdAdvSearchResultsEntityAssociation.Add(new CatalogSearchDefaultsClsdAdvSearchResults( value0, value1));
				}
			}
	...
	[Serializable]
	public class CatalogSearchDefaultsClsdAdvSearchResults
	{
		public string ClsdAdvSearchElementsAssocMember;	
		public string ClsdAdvSearchHideAssocMember;	
		public CatalogSearchDefaultsClsdAdvSearchResults() {}
		public CatalogSearchDefaultsClsdAdvSearchResults(
			string inClsdAdvSearchElements,
			string inClsdAdvSearchHide)
		{
			ClsdAdvSearchElementsAssocMember = inClsdAdvSearchElements;
			ClsdAdvSearchHideAssocMember = inClsdAdvSearchHide;
		}
	}
}
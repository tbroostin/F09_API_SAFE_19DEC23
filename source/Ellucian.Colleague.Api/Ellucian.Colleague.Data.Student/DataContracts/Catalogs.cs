...
//     Last generated on 10/26/2018 2:40:31 PM by user riteshagarwal2
//
//     Type: ENTITY
//     Entity: CATALOGS
//     Application: ST
...
namespace Ellucian.Colleague.Data.Student.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "10/26/2018 2:40:31 PM", User = "riteshagarwal2")]
	...
	public class Catalogs : IColleagueGuidEntity
	{
		...
		/// <summary>
		/// CDD Name: CAT.HIDE.IN.SS.WHAT.IF
		/// </summary>
		[DataMember(Order = 20, Name = "CAT.HIDE.IN.SS.WHAT.IF")]
		public string CatHideInSsWhatIf { get; set; }

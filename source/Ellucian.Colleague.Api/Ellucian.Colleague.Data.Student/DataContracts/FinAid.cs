...
//     Last generated on 7/17/2018 2:56:51 PM by user sbhole1
//
//     Type: ENTITY
//     Entity: FIN.AID
//     Application: ST
...
namespace Ellucian.Colleague.Data.Student.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "7/17/2018 2:56:51 PM", User = "sbhole1")]
	...
	public class FinAid : IColleagueEntity
	{
		...
		/// <summary>
		/// CDD Name: FA.CAP.CODE
		/// </summary>
		[DataMember(Order = 54, Name = "FA.CAP.CODE")]
		public string FaCapCode { get; set; }

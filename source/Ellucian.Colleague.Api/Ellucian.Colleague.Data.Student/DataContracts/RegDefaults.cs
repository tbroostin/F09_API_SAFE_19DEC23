...
//     Last generated on 3/1/2023 1:19:50 PM by user pbhaumik2
//
//     Type: ENTITY
//     Entity: REG.DEFAULTS
//     Application: ST
...
namespace Ellucian.Colleague.Data.Student.DataContracts
{
	...
	[ColleagueDataContract(GeneratedDateTime = "3/1/2023 1:19:50 PM", User = "pbhaumik2")]
	...
	public class RegDefaults : IColleagueEntity
	{
		...
		/// <summary>
		/// CDD Name: RGD.ADD.AUTH.EXCEED.CAPACITY
		/// </summary>
		[DataMember(Order = 39, Name = "RGD.ADD.AUTH.EXCEED.CAPACITY")]
		public string RgdAddAuthExceedCapacity { get; set; }
		...
		/// <summary>
		/// CDD Name: RGD.SEAT.SERVICE.ENABLED
		/// </summary>
		[DataMember(Order = 46, Name = "RGD.SEAT.SERVICE.ENABLED")]
		public string RgdSeatServiceEnabled { get; set; }
		
		/// <summary>
		/// CDD Name: RGD.BYPASS.ADD.AUTH.WAITLIST
		/// </summary>
		[DataMember(Order = 53, Name = "RGD.BYPASS.ADD.AUTH.WAITLIST")]
		public string RgdBypassAddAuthWaitlist { get; set; }

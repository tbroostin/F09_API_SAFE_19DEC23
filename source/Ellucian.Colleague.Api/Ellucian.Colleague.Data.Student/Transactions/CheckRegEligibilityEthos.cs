...
//     Last generated on 10/5/2017 2:10:29 PM by user dvcoll-schandraseka
//
//     Type: CTX
//     Transaction ID: CHECK.REG.ELIGIBILITY.ETHOS
//     Application: ST
//     Environment: dvColl
//
...
{
	[DataContract]
	public class EthosTerms
	{
		[DataMember]
		[SctrqDataMember(AppServerName = "TERM.CODE", InBoundData = true, OutBoundData = true)]
	...
	[DataContract]
	[ColleagueDataContract(ColleagueId = "CHECK.REG.ELIGIBILITY.ETHOS", GeneratedDateTime = "10/5/2017 2:10:29 PM", User = "dvcoll-schandraseka")]
	[SctrqDataContract(Application = "ST", DataContractVersion = 1)]
	public class CheckRegEligibilityEthosRequest
	{
		/// <summary>
		/// Version
		/// </summary>
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "Grp:TERM.CODE", InBoundData = true)]
		public List<EthosTerms> EthosTerms { get; set; }

		public CheckRegEligibilityEthosRequest()
		{	
	...
	[ColleagueDataContract(ColleagueId = "CHECK.REG.ELIGIBILITY.ETHOS", GeneratedDateTime = "10/5/2017 2:10:29 PM", User = "dvcoll-schandraseka")]
	[SctrqDataContract(Application = "ST", DataContractVersion = 1)]
	public class CheckRegEligibilityEthosResponse
	{
		/// <summary>
		/// Version
		/// </summary>
		...
		public CheckRegEligibilityEthosResponse()
		{	

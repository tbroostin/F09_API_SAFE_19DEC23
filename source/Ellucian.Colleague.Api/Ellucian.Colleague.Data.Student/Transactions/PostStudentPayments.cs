...
//     Last generated on 10/21/2019 4:06:14 PM by user dvcoll-srm
//
//     Type: CTX
...
namespace Ellucian.Colleague.Data.Student.Transactions
{
	...
	[DataContract]
	[ColleagueDataContract(ColleagueId = "CREATE.AR.PAYMENT", GeneratedDateTime = "10/21/2019 4:06:14 PM", User = "dvcoll-srm")]
	...
	public class PostStudentPaymentsRequest
	{
		...
		[DataMember]
		[SctrqDataMember(AppServerName = "ARP.INTG.USAGE", InBoundData = true)]        
		public string ArpIntgUsage { get; set; }

		[DataMember]
		[DisplayFormat(DataFormatString = "{0:d}")]
		[SctrqDataMember(AppServerName = "ARP.INTG.ORIGINATED.ON", InBoundData = true)]        
		public Nullable<DateTime> ArpIntgOriginatedOn { get; set; }

		[DataMember]
		[SctrqDataMember(AppServerName = "ARP.INTG.OVERRIDE.DESC", InBoundData = true)]        

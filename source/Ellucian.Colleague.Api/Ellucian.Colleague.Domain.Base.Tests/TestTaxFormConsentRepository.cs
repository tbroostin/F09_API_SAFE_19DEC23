...
namespace Ellucian.Colleague.Domain.Base.Tests
{
    ...
    {
        private List<TaxFormConsent2> consents2 = new List<TaxFormConsent2>()
        {
            new TaxFormConsent2("0003946", TaxFormTypes.FormW2, false, new DateTimeOffset(new DateTime(2015, 07, 09, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormW2, true, new DateTimeOffset(new DateTime(2015, 07, 10, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormW2, false, new DateTimeOffset(new DateTime(2015, 07, 11, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormW2, true, new DateTimeOffset(new DateTime(2015, 07, 12, 02, 42, 19))),

            new TaxFormConsent2("0003946", TaxFormTypes.Form1095C, false, new DateTimeOffset(new DateTime(2015, 08, 09, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1095C, true, new DateTimeOffset(new DateTime(2015, 08, 10, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1095C, false, new DateTimeOffset(new DateTime(2015, 08, 11, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1095C, true, new DateTimeOffset(new DateTime(2015, 08, 12, 02, 42, 19))),

            new TaxFormConsent2("0003946", TaxFormTypes.Form1098, false, new DateTimeOffset(new DateTime(2015, 09, 09, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1098, true, new DateTimeOffset(new DateTime(2015, 09, 10, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1098, false, new DateTimeOffset(new DateTime(2015, 09, 11, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1098, true, new DateTimeOffset(new DateTime(2015, 09, 12, 02, 42, 19))),

            new TaxFormConsent2("0003946", TaxFormTypes.FormT4, false, new DateTimeOffset(new DateTime(2015, 09, 09, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT4, true, new DateTimeOffset(new DateTime(2015, 09, 10, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT4, false, new DateTimeOffset(new DateTime(2015, 09, 11, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT4, true, new DateTimeOffset(new DateTime(2015, 09, 12, 02, 42, 19))),

            new TaxFormConsent2("0003946", TaxFormTypes.FormT4A, false, new DateTimeOffset(new DateTime(2015, 09, 09, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT4A, true, new DateTimeOffset(new DateTime(2015, 09, 10, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT4A, false, new DateTimeOffset(new DateTime(2015, 09, 11, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT4A, true, new DateTimeOffset(new DateTime(2015, 09, 12, 02, 42, 19))),

            new TaxFormConsent2("0003946", TaxFormTypes.FormT2202A, false, new DateTimeOffset(new DateTime(2015, 09, 09, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT2202A, true, new DateTimeOffset(new DateTime(2015, 09, 10, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT2202A, false, new DateTimeOffset(new DateTime(2015, 09, 11, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.FormT2202A, true, new DateTimeOffset(new DateTime(2015, 09, 12, 02, 42, 19))),

            new TaxFormConsent2("0003946", TaxFormTypes.Form1099MI, false, new DateTimeOffset(new DateTime(2015, 09, 09, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1099MI, true, new DateTimeOffset(new DateTime(2015, 09, 10, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1099MI, false, new DateTimeOffset(new DateTime(2015, 09, 11, 02, 42, 19))),
            new TaxFormConsent2("0003946", TaxFormTypes.Form1099MI, true, new DateTimeOffset(new DateTime(2015, 09, 12, 02, 42, 19))),
        };
        ...
        {
            return await Task.FromResult(this.consents2.Where(x => x.TaxForm == taxForm).ToList());
        }

        public async Task<TaxFormConsent2> Post2Async(TaxFormConsent2 inputConsent)
        {

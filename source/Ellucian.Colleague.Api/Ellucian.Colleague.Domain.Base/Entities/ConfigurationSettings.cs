...
namespace Ellucian.Colleague.Domain.Base.Entities
{
    ...
    /// </summary>
    [Serializable]
    public class ConfigurationSettings : GuidCodeItem
    {
        /// <summary>
        /// List of resources which use this configuration settings item
        /// </summary>
        public List<string> EthosResources { get; set; }
        ...
        /// <summary>
        /// Allow Multiple Values to be defined for this configuration setting
        /// </summary>
        ...
        public ConfigurationSettings(string guid, string code, string description)

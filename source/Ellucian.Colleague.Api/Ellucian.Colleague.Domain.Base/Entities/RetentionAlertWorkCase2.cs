...
namespace Ellucian.Colleague.Domain.Base.Entities
{
    ...
    /// </summary>
    [Serializable]
    public class RetentionAlertWorkCase2
    {
        /// <summary>
        ...
        /// </summary>
        public List<string> CaseOwnerIds { get; set; }

        /// <summary>
        /// Case role of this work item
        /// </summary>
        public List<string> CaseRole { get; set; }

        /// <summary>
        /// Case role ids of this work item
        /// </summary>
        public List<int> CaseRoleIds { get; set; }
        ...
        // Defaut constructor
        public RetentionAlertWorkCase2()
        {
        ...
        public RetentionAlertWorkCase2(string caseId, string studentId)
        {
        ...
        public RetentionAlertWorkCase2(string caseId, string status, string closedBy, DateTime? closedDate)
        {
            if (string.IsNullOrEmpty(caseId))
            {
                throw new ArgumentNullException("caseId", "Case Id must be specified.");

...
namespace Ellucian.Colleague.Domain.ColleagueFinance.Repositories
{
    ...
    public interface IGeneralLedgerActivityDetailRepository
    {
        ...
        Task<GlAccountActivityDetail> QueryGlActivityDetailAsync(string glAccount, string fiscalYear, CostCenterStructure costCenterStructure, GeneralLedgerClassConfiguration glClassConfiguration);
    }
}

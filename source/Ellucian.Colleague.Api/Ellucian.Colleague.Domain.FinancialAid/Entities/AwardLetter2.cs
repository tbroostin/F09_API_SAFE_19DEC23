...
{
    /// <summary>
    /// The AwardLetter Entity provides all the data on a student's award letter.
    /// This record is generated from data stored in the AwardLetterHistory file in Colleague.
    /// </summary> 
    [Serializable]
    public class AwardLetter2
    {
        /// <summary>
        ...
        public AwardLetter2(string studentId, StudentAwardYear studentAwardYear)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            var awardLetter = obj as AwardLetter2;

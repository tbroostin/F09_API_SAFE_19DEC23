...
{
    public class TestEmploymentStatusEndingReasonRepository
    {
        ...
        public IEnumerable<EmploymentStatusEndingReason> GetEmploymentStatusEndingReasons()
        {
            var empTerminationReasonList = new List<EmploymentStatusEndingReason>();
            ...
            {
                empTerminationReasonList.Add(new EmploymentStatusEndingReason(employmentTerminationReasons[x, 0], employmentTerminationReasons[x, 1], employmentTerminationReasons[x, 2]));
            }

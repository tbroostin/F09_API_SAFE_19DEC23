...
{
    /// <summary>
    /// Domain Entity for employee benefits enrollment details
    /// </summary>
    [Serializable]
    public class EmployeeBenefitsEnrollmentDetail
    {
        ...
        /// <summary>
        /// Ids of dependents associated to detail record
        /// </summary>
        ...
        /// <summary>
        /// Ids of beneficiaries associated to detail record
        /// </summary>
        ...
        /// Constructuor
        /// </summary>
        public EmployeeBenefitsEnrollmentDetail()
        {
        }
    }
}

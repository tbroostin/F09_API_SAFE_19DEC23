...
{
    /// <summary>
    /// Employee Benefits Enrollment Domain Entity containing benefits enrollment information
    /// </summary>
    [Serializable]
    public class EmployeeBenefitsEnrollmentPoolItem
    {
        public EmployeeBenefitsEnrollmentPoolItem() { }
        ...
        /// <summary>
        /// Constructor for EmployeeBenefitsEnrollmentPoolItem
        /// </summary>
        /// <param name="itemId"></param>
        public EmployeeBenefitsEnrollmentPoolItem(string itemId, string organizationName, string lastName)
        {
            if (string.IsNullOrEmpty(itemId))
            {
                throw new ArgumentNullException("itemId", "itemId is required.");
            }

            if (string.IsNullOrEmpty(organizationName) && string.IsNullOrEmpty(lastName))
            {

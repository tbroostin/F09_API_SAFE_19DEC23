...
namespace Ellucian.Colleague.Domain.Student.Entities
{
    ...
    /// </summary>
    [Serializable]
    public class AcademicCreditMinimum
    {
        // Required Ids
        private string _Id;
        /// <summary>
        ...
        public AcademicCreditMinimum(string id)
        {
            if (id == null)
            {
        ...
        //public AcademicCreditMinimum(string id, Course course, string sectionid)
        //    : this(id)
        //{
        //    if (course == null)
        //    {
        ...
        public override bool Equals(object obj)
        {
            ...
            AcademicCreditMinimum other = obj as AcademicCreditMinimum;
            if (other == null)
            {
                return false;
            }

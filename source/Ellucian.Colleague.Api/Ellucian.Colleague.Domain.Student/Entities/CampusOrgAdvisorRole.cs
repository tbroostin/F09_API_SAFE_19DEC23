...
{
    [Serializable]
    public class CampusOrgAdvisorRole
    {
        ...
        public CampusOrgAdvisorRole(string id, string role, decimal? intendedLoad, string assignment, DateTime? startDate, DateTime? endDate)
        {
            Id = id;
            Role = role;

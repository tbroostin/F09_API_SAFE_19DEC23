...
{
    [Serializable]
    public class CampusOrgMemberRole
    {
        ...
        public CampusOrgMemberRole(string id, string role, decimal? intendedLoad, string assignment, DateTime? startDate, DateTime? endDate)
        {
            Id = id;
            Role = role;

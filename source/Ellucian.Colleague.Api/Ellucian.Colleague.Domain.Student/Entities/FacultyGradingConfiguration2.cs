...
namespace Ellucian.Colleague.Domain.Student.Entities
{
    ...
    public class FacultyGradingConfiguration2
    {
        ...
        /// <summary>
        /// Constructor for FacultyGradingConfiguration2
        /// </summary>
        public FacultyGradingConfiguration2()
        {
            ...
            FinalGradesLastDateAttendedDisplayBehavior = LastDateAttendedNeverAttendedFieldDisplayType.Editable;
            MidtermGradesLastDateAttendedDisplayBehavior = LastDateAttendedNeverAttendedFieldDisplayType.Editable;
            FinalGradesNeverAttendedDisplayBehavior = LastDateAttendedNeverAttendedFieldDisplayType.Editable;
            MidtermGradesNeverAttendedDisplayBehavior = LastDateAttendedNeverAttendedFieldDisplayType.Editable;
            ShowPassAudit = false;
            ShowRepeated = false;

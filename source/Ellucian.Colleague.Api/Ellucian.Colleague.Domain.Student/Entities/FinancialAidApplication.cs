...
namespace Ellucian.Colleague.Domain.Student.Entities
{
    ...
    /// </summary>
    [Serializable]
    public abstract class FinancialAidApplication
    {
        /// <summary>
        ...
        protected FinancialAidApplication(string id, string awardYear, string studentId)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            var financialAidApplication = obj as FinancialAidApplication;

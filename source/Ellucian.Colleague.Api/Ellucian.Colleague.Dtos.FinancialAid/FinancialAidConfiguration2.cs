...
{
    /// <summary>
    /// A FinancialAidConfiguration2 DTO contains data about how a Financial Aid office
    /// wants to expose data and control certain actions for a given award year
    /// </summary>
    public class FinancialAidConfiguration2
    {
        /// <summary>
        ...
        /// <summary>
        /// List of award status categories to be excluded from viewing
        /// on award letter and shopping sheet
        /// </summary>
        public IEnumerable<AwardStatusCategory> ExcludeFromAwardLetterAndShoppingSheet { get; set; }

...
{
    /// <summary>
    /// The FinancialAidOffice2 DTO contains demographic data about a specific financial aid office
    /// and the office's list of configurations
    /// </summary>
    public class FinancialAidOffice2
    {
        /// <summary>
        ...
        /// </summary>
        public List<FinancialAidConfiguration2> Configurations { get; set; }

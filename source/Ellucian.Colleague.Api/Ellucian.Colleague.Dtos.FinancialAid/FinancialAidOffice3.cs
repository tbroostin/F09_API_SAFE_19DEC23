...
{
    /// <summary>
    /// The FinancialAidOffice3 DTO contains demographic data about a specific financial aid office
    /// and the office's list of configurations
    /// </summary>
    public class FinancialAidOffice3
    {
        /// <summary>
        ...
        /// </summary>
        public List<FinancialAidConfiguration3> Configurations { get; set; }

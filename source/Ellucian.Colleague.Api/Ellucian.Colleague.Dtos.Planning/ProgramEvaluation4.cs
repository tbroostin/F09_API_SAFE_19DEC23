...
using AcademicCredit = Ellucian.Colleague.Dtos.Student.Requirements.AcademicCredit;
...
namespace Ellucian.Colleague.Dtos.Planning
{
    ...
    /// </summary>
    public class ProgramEvaluation4
    {
        /// <summary>
        ...
        /// <summary>
        /// List of evaluation <see cref="RequirementResult3">RequirementResult</see> items
        /// </summary>
        public List<RequirementResult3> RequirementResults { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<AcademicCredit> OtherAcademicCredits { get; set; }

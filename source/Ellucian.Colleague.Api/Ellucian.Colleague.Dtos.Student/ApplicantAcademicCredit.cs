...
{
    /// <summary>
    /// Credits earned by an applicant (usually this would be transfer or non-course credits if an applicant is not moved to Student)
    /// </summary>
    public class ApplicantAcademicCredit
    {
        /// <summary>
        ...
        /// </summary>
        public ApplicantAcademicCredit()
        {

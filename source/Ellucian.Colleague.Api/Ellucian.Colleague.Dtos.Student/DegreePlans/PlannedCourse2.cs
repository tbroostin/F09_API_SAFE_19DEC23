...
namespace Ellucian.Colleague.Dtos.Student.DegreePlans
{
    ...
    public class PlannedCourse2
    {
        ...
        /// <summary>
        /// List of validation messages associated with this course/section. May include <see cref="DegreePlanWarning">DegreePlanWarning</see> messages for corequisites
        /// unmet or for time conflicts between scheduled sections, for example. 
        /// </summary>
        public List<PlannedCourseWarning> Warnings { get; set; }

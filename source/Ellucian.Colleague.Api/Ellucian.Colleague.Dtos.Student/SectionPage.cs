...
namespace Ellucian.Colleague.Dtos.Student
{
    ...
    public class SectionPage : DataPage<Section3>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="allItems">List of <see cref="Section3">Section</see> items</param>
        /// <param name="pageSize">Size of page to construct</param>
        /// <param name="pageIndex">Page number</param>
        public SectionPage(IEnumerable<Section3> allItems, int pageSize, int pageIndex)

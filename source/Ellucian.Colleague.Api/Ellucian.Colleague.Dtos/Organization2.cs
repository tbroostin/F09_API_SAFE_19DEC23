...
namespace Ellucian.Colleague.Dtos
{
    ...
    public class Organization2 : BaseModel2
    {
        /// <summary>
        ...
        public IEnumerable<DtoProperties.OrganizationRoleDtoProperty> Roles { get; set; }
        ...
        public IEnumerable<DtoProperties.CredentialDtoProperty> Credentials { get; set; }

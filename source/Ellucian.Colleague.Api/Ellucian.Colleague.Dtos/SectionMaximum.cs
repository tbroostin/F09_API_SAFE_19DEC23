...
namespace Ellucian.Colleague.Dtos
{
    ...
    public class SectionMaximum
    {
        ...
        public DtoProperties.AcademicPeriodDtoProperty AcademicPeriod { get; set; }
        ...
        /// </summary>
        [JsonProperty("owningOrganizations", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        public IEnumerable<DtoProperties.CreditDtoProperty> Credits { get; set; }

        /// <summary>
        /// Owning Organizations for the section
        /// </summary>
        [JsonProperty("awardGradeSchemes", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public IEnumerable<DtoProperties.GradeSchemeDtoProperty> AwardGradeSchemes { get; set; }

        /// <summary>
        /// Owning Organizations for the section
        /// </summary>
        [JsonProperty("transcriptGradeSchemes", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public IEnumerable<DtoProperties.GradeSchemeDtoProperty> TranscriptGradeSchemes { get; set; }

        /// <summary>
        /// InstructionalEvents for the section
        /// </summary>
        [JsonProperty("instructionalEvents", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public IEnumerable<DtoProperties.InstructionalEventDtoProperty> InstructionalEvents { get; set; }

        /// <summary>
        /// Contructor
        /// </summary>
        [JsonConstructor]
        public SectionMaximum() : base()
        {
